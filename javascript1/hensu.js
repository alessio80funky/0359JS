...
①  キャメルケース　＝＞　lastName ＝＞　変数名と関数によく使われます

②　スネークケース　＝＞　last_name ＝＞　定数に使われます（API,DB）

③　パスカルケース　＝＞　LastName  ＝＞　クラスという特殊関数につかわれます。（この授業では取り扱わないです。）

④  ケバブケース　　＝＞　last-name  ＝＞　htmlのidやclassにつかわれます。
